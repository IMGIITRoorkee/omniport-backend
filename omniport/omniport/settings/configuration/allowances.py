...
# Allowed hosts, sourced solely from configuration. Do not append localhost or
# other hosts here: ALLOWED_HOSTS is a host-header defence and every allowed
# host must be an explicit, reviewed configuration entry.
