    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, max_length=255, null=True, upload_to=formula_one.utils.upload_to.UploadTo('open_auth', 'application_logos'), validators=[formula_one.validators.aspect_ratio.AspectRatioValidator(1)])),
